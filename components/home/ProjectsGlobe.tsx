...
const World = dynamic(() => import("../banner/Globe").then((m) => m.World), {
  ssr: false,
});
type ProjectsGlobe = {
  children?: ReactNode;
};
export const ProjectsGlobe = ({ children }: ProjectsGlobe) => {
  const CONFIG = {
    pointSize: 4,
    globeColor: "#062056",
    showAtmosphere: true,
  ...
  return (
    <div className="relative flex h-full flex-row items-center justify-center py-20 md:h-auto">
      <div className="relative mx-auto size-full max-w-7xl overflow-hidden px-4 md:h-[40rem]">
        ...
        <div className="absolute -bottom-20 z-10 h-72 w-full md:h-full">
          <World data={sampleArcs} globeConfig={CONFIG} />
        </div>
      </div>
    </div>
  );
