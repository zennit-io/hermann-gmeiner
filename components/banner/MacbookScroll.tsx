...
const MacbookScroll = ({
  ...
  useEffect(() => {
    ...
    switch (true) {
      case width > parsePixelAmounts(screens.lg):
        ...
        break;
      case width < parsePixelAmounts(screens.lg) &&
        width > parsePixelAmounts(screens.md):
        setScaleFactor(1);
        break;
      case width < parsePixelAmounts(screens.md) &&
        width > parsePixelAmounts(screens.sm):
        setScaleFactor(0.5);
        break;
      case width < parsePixelAmounts(screens.sm):
        setScaleFactor(0.35);
        break;
      default:
        setScaleFactor(0.35);
  ...
  const rounded = useTransform(scrollYProgress, [0, 0.3], [8, 0]);
  //
...
export const MacbookLid = ({
  ...
  return (
    <div className="relative [perspective:800px]" id={"macbook-lid"}>
      <div
        style={{
      ...
      >
        ...
        >
          <span className="text-white [perpective:800px] [transform-style:preserve-3d] [transform:rotateX(25deg)]">
            {children}
          </span>
        </div>
      </div>
      <motion.div
        ...
        className="absolute inset-0 h-96 w-[32rem] overflow-hidden bg-[#010101] p-2"
      >
        <div className="absolute inset-0 bg-foreground" />
        <motion.div className="absolute inset-0 size-full overflow-hidden object-cover object-left-top">
          {source}
        </motion.div>
      </motion.div>
    </div>
